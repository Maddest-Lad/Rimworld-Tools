...
make submodules  # optional: initialize the RimSort reference submodule
```

RimSort is a read-only research reference; its code is never imported, copied or executed.
